...
MENUS: List[Menu] = [
    ...
    Menu('&Analysis', [
        ...
        _mi('&Spatial Luminance', cmd='analysis', lt='LumSpatial'),
        _mi('&Angular Luminance', cmd='analysis', lt='LumAngular'),
        _mi('Lum&Viewer', cmd='analysis'),
        _mi('&Encircled Energy', cmd='analysis', lt='EncircledEnergyIllum'),
        _mi('C&IE', cmd='analysis', lt='CIEColorDiffIllumChart'),
        _mi('CC&T LumViewer', cmd='analysis', lt='CCTLineIllum'),
        _mi('Color &Difference Chart', cmd='analysis'),
        _mi('Region Analysis', cmd='analysis'),
        _mi('&Add Intensity Mesh', cmd='analysis', lt='MeshIntensity'),
        _mi('&Automotive Test Point Analyzer', cmd='analysis', lt='AutomotiveTestPoints'),
    ]),
    Menu('&Optimization', [
        _mi('&Optimize!', cmd='optimization', lt='Optimize'),
        _mi('&Variables…', cmd='optimization'),
        _mi('&Constraints…', cmd='optimization'),
        _mi('&Merit Function…', cmd='optimization', lt='AddMeshMeritFunction'),
        _mi('&Results…', cmd='optimization'),
        _mi('&Clear Results', cmd='optimization'),
        _mi('&Backlight Pattern Optimization', cmd='optimization', lt='BacklightPatternOptimization'),
    ]),
    Menu('&Tolerancing', [
        _mi('Tolerancing &Manager…', cmd='tolerancing', lt='TolerancingInput'),
        _mi('Tolerance &Sensitivities…', cmd='tolerancing', lt='ToleranceSensitivities'),
        _mi('Add User Defined &Tolerance Group…', cmd='tolerancing'),
    ]),
    Menu('&Photoreal', [
